...
low_sucrose_experiment_data<-read.csv("Combined ant choices_Low sucrose experiment_2025.csv")

high_sucrose_experiment_data<-read.csv("Combined ant choices_High sucrose experiment_2025.csv")
