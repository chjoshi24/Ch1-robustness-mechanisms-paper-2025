...
low_sucrose_experiment_data<-read.csv("Combined ant choices_Low sucrose experiment_2025_edited.csv")

high_sucrose_experiment_data<-read.csv("Combined ant choices_High sucrose experiment_2025_edited.csv")
...
#Binomial test for control data
binom.test(2,34,0.5) #Significant
#Significantly more ants stay on the trail than abandon here
...
gaster_angle_low_sucrose<-read.csv("Combined gaster angles_Low sucrose experiment_2025.csv")
...
gaster_angle_high_sucrose<-read.csv("Combined gaster angles_High sucrose experiment_2025.csv")
...
```{r}
wilcox.test(gaster_angle_low_sucrose_ready$mean_gaster_angle~gaster_angle_low_sucrose_ready$Treatment) #No Significant difference
...
stripchart(mean_gaster_angle~Treatment,method="jitter",add=T,vertical=T,pch=20,data=gaster_angle_low_sucrose_ready[gaster_angle_low_sucrose_ready$Year==2025, ])
...
stripchart(mean_gaster_angle~Treatment,method="jitter",add=T,vertical=T,pch=20,data=gaster_angle_high_sucrose_ready[gaster_angle_high_sucrose_ready$Year==2025, ])
