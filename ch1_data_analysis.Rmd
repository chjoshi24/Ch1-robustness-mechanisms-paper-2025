...
geom_bar(aes(fill=choices))+
  ...
  scale_x_discrete(labels=c("Control_1.5m"="Control 1.5M","Control_3m"= "Control 3M", "Exp_1.5m"="Experimental 1.5M","Exp_3m" = "Experimental 3M"))+geom_text(data=sample_size,aes (x=exp_type,y=35),label=paste("n=",sample_size$total))
